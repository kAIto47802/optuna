...
def main(args: Namespace) -> None:
    ...
    np.savez(
        f"results/bbob_fn{args.function_id}_dim{args.dimension}_scipy{scipy.__version__}-{args.suffix}_trial{args.n_trials}.npz",
...
### b: decorator on loss_func
### c: decorator on _fit_kernel_params
### d: contextmanager on so.minimize in _fit_kernel_params
